...
For this project, uses the [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment to train 20 robot arms to move to intended targets.
...
Then run the continuous_control.ipynb notebook.
